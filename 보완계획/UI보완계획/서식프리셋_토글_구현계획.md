...
> 이 계획은 [메모편집_보완계획](../메모편집_보완계획.md) **단계 C의 C1·C3**(서식 토글 위치, 서식 1~3, `⚙`)을 구체화해 **대체**합니다. C2의 "툴바 2줄" 요구는 이 계획의 단계 C로 함께 처리합니다. C4(카테고리 칩)와 백링크 버튼은 건드리지 않습니다.

---

## 01 — 현재 코드 진단

![현재 머리 영역 문제 지점](01_현재_머리영역_문제지점.png)
...
![서식 버튼 상태와 메뉴](03_서식버튼_상태와메뉴.png)
...
Q4·Q5 모두 추천안(A)으로 진행할까요? 괜찮으시면 **단계 A(서식 토글 이동)** 부터 시작하겠습니다.
