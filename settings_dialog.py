...
class SettingsDialog(QDialog):
    def __init__(
        ...
        self.full_backup_button = QPushButton("전체 백업")
        self.full_backup_button.setAccessibleName("전체 백업")
        ...
        self.full_restore_button = QPushButton("전체 복원")
        self.full_restore_button.setAccessibleName("전체 복원")
